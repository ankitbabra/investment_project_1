...
public class WordGenerator {
    ...
    public static String GenerateDoc(String TC_ID) throws Exception {
        ...
        paragraphOneRunOne.addBreak();
        paragraphOneRunOne.addBreak();
        XWPFRun paragraphOneRunOne2 = paragraph.createRun();
        paragraphOneRunOne2.setBold(true);
        paragraphOneRunOne2.setItalic(true);
        paragraphOneRunOne2.setFontSize(15);
        paragraphOneRunOne2.setText("Execution Started:" +timeStamp);
